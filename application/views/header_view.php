...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url('dashboard');?>" class="logo">
      ...
      <span class="logo-lg"><b><img src="<?php echo base_url();?>assets_style/image/loggo.png" width="50" height="50">Perpus</b> | SMK 3 Cileungsi</span>
      <!-- logo for regular state and mobile devices -->
      <!-- <span class="logo-lg"><img src="assets_style/image/logo.jpg">Perpustakaan SMK 3 Cileungsi</span> -->
    </a>
