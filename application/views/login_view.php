...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/login.png');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:2px solid #00FFFF;"> <center><img src="assets_style/image/loggo.png" width="100" height="100"></center>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: black;"> Copyright &copy; Sistem Informasi Perpustakaan - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
