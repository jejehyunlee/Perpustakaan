      ...
      <div class="user-panel">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview"> 
                ...
                <ul class="treeview-menu">
                    <li class="<?php if($this->uri->uri_string() == 'user'){ echo 'active';}?>
                        <?php if($this->uri->uri_string() == 'user/Lap_pdf'){ echo 'active';}?>
                        ">
                        <a href="<?php echo base_url('user/Lap_pdf');?>" class="cursor">
                    <i class="fa fa-print"></i> <span> Laporan Data Pengguna</span></a>
                    </li>
                    <li class="<?php if($this->uri->uri_string() == 'data'){ echo 'active';}?>
                        <?php if($this->uri->uri_string() == 'data/Lap_pdf'){ echo 'active';}?>
                        <">
                        <a href="<?php echo base_url("data/Lap_pdf");?>" class="cursor">
                            <span class="fa fa-print"></span> Laporan Data Buku
                    </li>        
                        </a>
                    <li class="<?php if($this->uri->uri_string() == 'transaksi'){ echo 'active';}?>
                        <?php if($this->uri->uri_string() == 'transaksi/pinjam'){ echo 'active';}?>
                        <?php if($this->uri->uri_string() == 'transaksi/kembalipinjam/'.$this->uri->segment('3')){ echo 'active';}?>">
                        <a href="<?php echo base_url("transaksi/Lap_pdfpinjam");?>" class="cursor">
                            <span class="fa fa-print"></span> Laporan Peminjaman
                            
                        </a>
                    </li>
                    <li class="<?php if($this->uri->uri_string() == 'transaksi/kembali'){ echo 'active';}?>">
                        <a href="<?php echo base_url("transaksi/Lap_pdfkembali");?>" class="cursor">
                            <span class="fa fa-print"></span> Laporan Pengembalian
                        </a>
                    </li>
                </ul>
            </li>
			...
			<?php if($this->session->userdata('level') == 'Anggota'){?>
				<li class="<?php if($this->uri->uri_string() == 'transaksi'){ echo 'active';}?>">
					<a href="<?php echo base_url("transaksi");?>" class="cursor">
						<i class="fa fa-download"></i> <span>Data Peminjaman </span>
					</a>
				</li>
				<li class="<?php if($this->uri->uri_string() == 'transaksi/kembali'){ echo 'active';}?>">
					<a href="<?php echo base_url("transaksi/kembali");?>" class="cursor">
